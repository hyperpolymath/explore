...
applications – directly on Windows, unmodified, without the overhead of
...
Languages: NodeJS, Javascript, Python, Ruby, C/C++, C# & F#, Rust, Go,
etc.

Services: SSHD, MySQL, Apache, lighttpd, MongoDB, PostgreSQL.

Install additional software using your own GNU/Linux distribution
package manager.
...
== Source: https://docs.microsoft.com/windows/wsl/about[Microsoft Docs]
